...
class categoryClass:
    def __init__(self,root):
        self.root=root
        self.root.geometry("1150x500+253+130")
        ...
        lbl_name=Label(self.root,text="Enter Category Name ",font=("goudy old style",18),bg="white").place(x=50,y=100)
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",18),bg="lightyellow").place(x=50,y=160,width=300)

        btn_add=Button(self.root,text="ADD",command=self.add,font=("goudy old style",18),bg="#4caf50",fg="white",cursor="hand2").place(x=360,y=160,width=150,height=30)
        btn_delete=Button(self.root,text="DELETE",command=self.delete,font=("goudy old style",18),bg="red",fg="white",cursor="hand2").place(x=520,y=160,width=150,height=30)
        ...
        self.categoryTable.heading("cid",text="Cat_ID")
